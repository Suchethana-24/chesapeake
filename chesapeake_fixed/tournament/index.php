...
<title>Tournament - Chesapeake Golf</title>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .page-hero {
    ...
    background-image: url(../wp-content/uploads/sites/7040/2019/08/Chesapeake12dff.jpg);
  ...
  /* ── TOURNAMENT FEATURES (like venue cards) ── */
  .features-section { background: var(--cream); padding: 80px 32px; }
  ...
  .fc-divider { width: 48px; height: 2px; background: var(--gold); margin-bottom: 20px; }
  .fc-desc { font-size: 14.5px; color: var(--mid); line-height: 1.8; margin-bottom: 32px; }
  .fc-grid {
  ...
  .fc-cell-note { font-size: 12px; color: var(--mid); margin-top: 2px; }

  /* ── PACKAGE PANEL (like Gazebo) ── */
  .package-section { background: var(--forest-dark); padding: 0 32px 80px; }
  .package-card {
  ...
  .package-stats { display: flex; gap: 16px; flex-shrink: 0; }
  .pkg-stat-box {
  ...
  .package-body { background: #0d4d41; padding: 48px 56px; }
  .package-desc {
  ...
  .package-dl-btn:hover { background: var(--crimson-dark); transform: translateY(-2px); text-decoration: none !important; }
  ...
  @media (max-width: 1024px) {
    ...
    .package-overlay { flex-direction: column; align-items: flex-start; gap: 20px; bottom: 28px; left: 28px; right: 28px; }
    .package-body { padding: 36px 28px; }
    .package-stats { flex-wrap: wrap; }
  }
  @media (max-width: 768px) {
    .site-header .wrap { padding: 0 16px; height: 60px; }
    ul#menu-top { display: none; }
    .features-section, .intro-strip { padding: 48px 20px; }
    .package-section, .cta-section { padding: 0 20px 48px; }
    .breadcrumb-bar { padding: 12px 20px; }
    .package-img-wrap { height: 320px; }
...
<div class="site-container">
        ...
        <div class="wrap">
          <ul id="menu-top" class="menu genesis-nav-menu menu-primary">
            ...
            <li class="menu-item current-menu-item">
              <a href="index.php" aria-current="page"><span>Tournament</span></a>
            </li>
  ...
  <div class="page-hero">
    <div class="page-hero-content">
      <p class="hero-eyebrow">Chesapeake Golf Club · 2025</p>
      <h1 class="page-hero-title">Tournament</h1>
      <p class="page-hero-sub">Host your next tournament on one of Hampton Roads' finest courses. Competitive play, premium facilities, and a seamless experience from tee-off to trophy.</p>
      <div class="hero-pill-row">
        <span class="hero-pill">Corporate Outings</span>
        <span class="hero-pill">Charity Events</span>
        <span class="hero-pill">Custom Packages</span>
      </div>
    </div>
  </div>
  ...
  <div class="breadcrumb-bar">
    <div class="inner">
      ...
      <span class="breadcrumb-current">Tournament</span>
    </div>
  </div>

  <div class="site-inner">
    <main id="genesis-content">
      <article class="entry" aria-label="Tournament">
        <header class="entry-header"><h1 class="entry-title">Tournament</h1></header>
        <div class="entry-content">
          ...
          <section class="intro-strip">
            <div class="intro-strip-inner">
              <div>
                <p class="section-label">Golf · Competition · Community</p>
                <h2 class="section-heading">Your Tournament,<br>Our Course</h2>
                <p class="section-body">Chesapeake Golf Club is the ideal setting for tournaments of all kinds — from corporate outings and charity fundraisers to competitive member events. Our experienced staff will work with you every step of the way to deliver an unforgettable day on the course.</p>
                <a href="../wp-content/uploads/sites/7040/2024/10/2025-Tournament-Package.pdf" class="intro-cta" target="_blank">
              ...
              <div class="intro-stat-row">
                <div class="intro-stat">
                  <span class="intro-stat-num">18</span>
                  <span class="intro-stat-label">Holes</span>
                </div>
                <div class="intro-stat">
                  <span class="intro-stat-num">144</span>
                  <span class="intro-stat-label">Max Players</span>
                </div>
                <div class="intro-stat">
                  <span class="intro-stat-num">2025</span>
                  <span class="intro-stat-label">Season Open</span>
                </div>
              </div>
            </div>
          </section>

          <!-- FEATURES / FORMAT CARDS -->
          <section class="features-section">
            <div class="features-inner">
              <p class="section-label">Tournament Options</p>
              <h2 class="section-heading">Built for Every Event</h2>

              <!-- CORPORATE OUTING -->
              <div class="feature-card">
                <div class="fc-img">
                  <span class="fc-badge">Option I</span>
                  <img src="../wp-content/uploads/sites/7040/2019/08/Chesapeake12dff.jpg" alt="Corporate Golf Outing" />
                </div>
                <div class="fc-body">
                  <span class="fc-tag">Business · Networking · Team Building</span>
                  <h3 class="fc-name">Corporate Golf Outing</h3>
                  <div class="fc-divider"></div>
                  <p class="fc-desc">Impress clients, reward employees, or strengthen business relationships with a professionally organized golf outing at Chesapeake Golf Club. We handle all the logistics — from cart assignments to on-course contests — so you can focus on your guests.</p>
                  <div class="fc-grid">
                    <div class="fc-cell">
                      <span class="fc-cell-label">Format</span>
                      <span class="fc-cell-val">Scramble</span>
                      <span class="fc-cell-note">or Best Ball</span>
                    </div>
                    <div class="fc-cell">
                      <span class="fc-cell-label">Min. Players</span>
                      <span class="fc-cell-val">16</span>
                      <span class="fc-cell-note">Up to 144</span>
                    </div>
                    <div class="fc-cell">
                      <span class="fc-cell-label">Shotgun Start</span>
                      <span class="fc-cell-val">Available</span>
                    </div>
                    <div class="fc-cell">
                      <span class="fc-cell-label">Catering</span>
                      <span class="fc-cell-val">Included</span>
                      <span class="fc-cell-note">Custom menus</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="feature-card reverse">
                <div class="fc-img">
                  <span class="fc-badge">Option II</span>
                  <img src="../wp-content/uploads/sites/7040/2021/09/Cedar-12dff.jpg" alt="Charity Golf Tournament" />
                </div>
                <div class="fc-body">
                  <span class="fc-tag">Fundraising · Community · Impact</span>
                  <h3 class="fc-name">Charity Tournament</h3>
                  <div class="fc-divider"></div>
                  <p class="fc-desc">Make your cause shine with a charity golf tournament at Chesapeake Golf Club. We partner with non-profits and organizations to deliver a first-class event that raises funds, builds awareness, and gives participants a day they'll talk about long after the last putt drops.</p>
                  <div class="fc-grid">
                    <div class="fc-cell">
                      <span class="fc-cell-label">Sponsorship</span>
                      <span class="fc-cell-val">Holes</span>
                      <span class="fc-cell-note">Signage included</span>
                    </div>
                    <div class="fc-cell">
                      <span class="fc-cell-label">Contests</span>
                      <span class="fc-cell-val">Custom</span>
                      <span class="fc-cell-note">Closest to pin, etc.</span>
                    </div>
                    <div class="fc-cell">
                      <span class="fc-cell-label">Awards</span>
                      <span class="fc-cell-val">Ceremony</span>
                      <span class="fc-cell-note">Banquet room avail.</span>
                    </div>
                    <div class="fc-cell">
                      <span class="fc-cell-label">Mulligans</span>
                      <span class="fc-cell-val">Add-On</span>
                      <span class="fc-cell-note">Great for fundraising</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section class="package-section">
            <div class="package-card">
              <div class="package-img-wrap">
                <img src="../wp-content/uploads/sites/7040/2019/08/Chesapeake12dff.jpg" alt="2025 Tournament Package" />
                <div class="package-overlay">
                  <div>
                    <span class="package-eyebrow">2025 Tournament Information</span>
                    <div class="package-title">Tournament<br>Package</div>
                  </div>
                  <div class="package-stats">
                    <div class="pkg-stat-box">
                      <span class="pkg-stat-num">18</span>
                      <span class="pkg-stat-label">Holes</span>
                    </div>
                    <div class="pkg-stat-box">
                      <span class="pkg-stat-num">144</span>
                      <span class="pkg-stat-label">Max Players</span>
                    </div>
                    <div class="pkg-stat-box">
                      <span class="pkg-stat-num">Full</span>
                      <span class="pkg-stat-label">Service</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="package-body">
                <p class="package-desc">The 2025 Chesapeake Golf Club Tournament Package includes everything you need to plan, execute, and celebrate a world-class golf event. From tee gift ideas and on-course contests to banquet dining and awards ceremonies, our comprehensive package is designed to make your event effortless and memorable. Download the full package below for detailed pricing, inclusions, and booking information.</p>
                <a href="../wp-content/uploads/sites/7040/2024/10/2025-Tournament-Package.pdf" class="package-dl-btn" target="_blank">
                  ...
                  Chesapeake Golf Club Tournament Package
                </a>
              </div>
            </div>
          </section>
          ...
          <section class="cta-section">
            <div class="cta-card">
              <div class="cta-left">
                <span class="cta-badge">Book Your Tournament</span>
                <h2 class="cta-title">Let's Tee Up<br>Your Event</h2>
                <p class="cta-desc">Ready to start planning? Our tournament team is here to walk you through every detail and build a custom package that fits your group, your goals, and your budget.</p>
                <div class="cta-btns">
                  ...
                  <a href="../wp-content/uploads/sites/7040/2024/10/2025-Tournament-Package.pdf" class="cta-btn-secondary" target="_blank">
              ...
              <div class="cta-right">
                <div class="cta-checklist">
                  <div class="cta-check-item">
                    ...
                    Shotgun &amp; Tee-Time Starts Available
                  </div>
                  <div class="cta-check-item">
                    <div class="cta-check-icon">
                      <svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>
                  ...
                  <div class="cta-check-item">
                    ...
                    Custom Catering &amp; Banquet Options
                  </div>
                  <div class="cta-check-item">
                    <div class="cta-check-icon">
                      <svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>
