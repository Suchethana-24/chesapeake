...
<title>Course History - Chesapeake Golf</title>
<link rel="canonical" href="index.php" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Course History - Chesapeake Golf" />
<meta property="og:url" content="https://www.chesapeakegolfclub.com/course/course-history/" />
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ══ HISTORY CARDS — identical to Event Hall venue-card ══ */
  .history-section { background: var(--cream); padding: 80px 32px; }
  ...
  /* Photo side — exactly like Event Hall .vc-img */
  .vc-img {
  ...
  /* Badge label — exactly like Event Hall .vc-num */
  .vc-num {
  ...
  /* Info side — exactly like Event Hall .vc-body */
  .vc-body {
  ...
  .vc-desc { font-size: 14.5px; color: var(--mid); line-height: 1.85; }

  /* ══ AWARDS SECTION — dark panel like Event Hall gazebo ══ */
  .awards-section { background: var(--forest-dark); padding: 0 32px 80px; }
  .awards-card {
  ...
  /* Awards header — image banner like gazebo-img-wrap */
  .awards-img-wrap {
  ...
  .awards-card:hover .awards-img-wrap img { transform: scale(1.04); }
  .awards-img-wrap::after {
    content: ''; position: absolute; inset: 0;
    background: linear-gradient(to top, rgba(2,20,16,0.90) 0%, rgba(3,78,66,0.4) 50%, transparent 78%);
  }
  .awards-overlay {
  ...
  /* Awards grid body — like gazebo-body but grid */
  .awards-body {
  ...
  .award-icon svg { width: 18px; height: 18px; stroke: var(--gold); fill: none; stroke-width: 2; }
  .award-name {
  ...
  @media (max-width: 1024px) {
    ...
    .awards-body { grid-template-columns: 1fr; }
    .award-item { border-right: none; border-bottom: 1px solid rgba(255,255,255,0.08); }
    .awards-overlay { flex-direction: column; align-items: flex-start; gap: 20px; bottom: 28px; left: 28px; right: 28px; }
    .awards-body { padding: 36px 28px; }
  }
  @media (max-width: 768px) {
.history-section, .intro-strip { padding: 48px 20px; }
    .awards-section, .cta-section { padding: 0 20px 48px; }
    .breadcrumb-bar { padding: 12px 20px; }
    .page-hero { height: 50vh; }
    .awards-img-wrap { height: 280px; }
    .awards-count-boxes { flex-direction: column; gap: 10px; }
  }
</style>
...
<body class="wp-singular page-template-default page page-id-96 page-child parent-pageid-39 wp-theme-genesis wp-child-theme-altitude-pro custom-header header-image header-full-width full-width-content genesis-breadcrumbs-hidden genesis-footer-widgets-hidden">
<div class="site-container">
      ...
      <nav class="nav-primary" aria-label="Main" id="genesis-nav-primary" id="genesis-nav-primary">
        <div class="wrap">
          ...
          <ul id="menu-top" class="menu genesis-nav-menu menu-primary js-superfish">
            <li id="menu-item-54" class="menu-item menu-item-type-post_type menu-item-home menu-item-54"><a href="../../index.php"><span>Home</span></a></li>
            <li id="menu-item-66" class="menu-item menu-item-type-custom menu-item-66"><a target="_blank" href="https://chesapeake-golf-club.book.teeitup.golf/"><span>Tee Times</span></a></li>
            <li id="menu-item-56" class="menu-item menu-item-type-post_type current-page-ancestor current-menu-ancestor current-menu-parent current-page-parent menu-item-has-children menu-item-56">
              ...
              <ul class="sub-menu">
                ...
                <li id="menu-item-115" class="menu-item current-menu-item page_item page-item-96 current_page_item menu-item-115"><a href="index.php" aria-current="page"><span>Course History</span></a></li>
                <li id="menu-item-117" class="menu-item menu-item-117"><a href="../driving-directions/index.php"><span>Driving Directions</span></a></li>
              </ul>
            </li>
  ...
  <!-- PAGE HERO — uses same image as Event Hall (1.jpg) -->
  <div class="page-hero">
    <div class="page-hero-content">
      <p class="hero-eyebrow">Chesapeake Golf Club</p>
      <h1 class="page-hero-title">Course History</h1>
      <p class="page-hero-sub">Chesapeake's first golf course — built in 1986, shaped by legend Ellis Maples, and cherished by Hampton Roads for nearly four decades.</p>
      <div class="hero-pill-row">
        <span class="hero-pill">Est. 1986</span>
        <span class="hero-pill">Ellis Maples Design</span>
        <span class="hero-pill">Par 71 · 18 Holes</span>
  ...
  <div class="breadcrumb-bar">
    <div class="inner">
      ...
      <span class="breadcrumb-sep">›</span>
      <span class="breadcrumb-current">Course History</span>
    </div>
  </div>
  ...
  <div class="site-inner">
    <div class="content-sidebar-wrap">
      <main class="content" id="genesis-content">
        <article class="post-96 page type-page status-publish entry" aria-label="Course History">
          <header class="entry-header"><h1 class="entry-title">Course History</h1></header>
          <div class="entry-content">
            ...
            <section class="intro-strip">
              <div class="intro-strip-inner">
                <div>
                  <p class="section-label">Est. 1986 · Chesapeake, Virginia</p>
                  <h2 class="section-heading">Hampton Roads'<br>Best-Kept Secret</h2>
                  <p class="section-body">Chesapeake Golf Club was the first course built in Chesapeake, designed by legendary architect Ellis Maples to accentuate the surrounding homes and challenge golfers with signature manmade ponds. Nearly four decades later, it remains one of the most beloved courses in the Tidewater area.</p>
                </div>
                <div class="intro-stat-row">
                  <div class="intro-stat">
                    <span class="intro-stat-num">1986</span>
                    <span class="intro-stat-label">Founded</span>
                  </div>
                  <div class="intro-stat">
                    <span class="intro-stat-num">18</span>
                    <span class="intro-stat-label">Holes · Par 71</span>
                  </div>
                  <div class="intro-stat">
                    <span class="intro-stat-num">6+</span>
                    <span class="intro-stat-label">Award Years</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="cta-section">
              <div class="cta-card">
                <div class="cta-left">
                  <span class="cta-badge">Come Play With Us</span>
                  <h2 class="cta-title">Be Part of<br>the Story</h2>
                  <p class="cta-desc">Nearly 40 years of history — and the best rounds are still ahead. Book your tee time and experience Hampton Roads' best-kept secret for yourself.</p>
                  <div class="cta-btns">
                ...
                <div class="cta-right">
                  <div class="cta-checklist">
                    <div class="cta-check-item">
                      ...
                      Chesapeake's First Golf Course
                    </div>
                    <div class="cta-check-item">
                      <div class="cta-check-icon"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div>
                      Designed by Architect Ellis Maples
                    </div>
                    <div class="cta-check-item">
                      <div class="cta-check-icon"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div>
                      Award-Winning Greens &amp; Course
                    </div>
                    <div class="cta-check-item">
                      <div class="cta-check-icon"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div>
                      Pro Shop, Driving Range &amp; Pool
                    </div>
                    <div class="cta-check-item">
                      <div class="cta-check-icon"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div>
                      Family Atmosphere Since 1987
                    </div>
                  </div>
                </div>
              </div>
...
var ghostkitVariables = {"version":"3.4.6","pro":"","themeName":"Genesis","settings":[],"disabledBlocks":[],"media_sizes":{"sm":576,"md":768,"lg":992,"xl":1200},"timezone":"UTC+00:00","googleMapsAPIKey":"","googleMapsAPIUrl":"https:\/\/maps.googleapis.com\/maps\/api\/js?v=3.exp&language=en","googleReCaptchaAPISiteKey":"","googleReCaptchaAPISecretKey":""};
</script>
...
_stq = window._stq || [];
_stq.push([ "view", {"v":"ext","blog":"158795460","post":"96","tz":"0","srv":"www.chesapeakegolfclub.com","hp":"vip","j":"1:15.4"} ]);
_stq.push([ "clickTrackerInit", "158795460", "96" ]);
</script>
